...
$("#menu-opciones")
	...
	.append('<li class="btn-floating sub-boton"><a href="https://github.com/vikserver/vikserver2" target="_blank"><i class="material-icons">code</i></a></li>');
...
load("typedJS").then(()=>{
	window.motd=new Typed("#motd", {
		strings: ["", "Tu trastero de links más rápido", "Tu trastero de links más privado", "Tu trastero de links más amigable"],
		typeSpeed: 50,
		backSpeed: 50,
		smartBackspace: true,
		showCursor: false
