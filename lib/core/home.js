...
class Eventos{
	...
	static collapBtn(){
		...
		$(".links-editar").on("click", function(){
			let selectores={
				link: $(this).parent("ul").parent("div").parent("div").children("a[href]:not([shared])"),
				desc: $(this).parent("ul").parent("div").parent("div").parent("li").children("div[data-desc]"),
				shared: $(this).parent("ul").parent("div").parent("div").children("a[href][shared]")
			};
			let datos={
